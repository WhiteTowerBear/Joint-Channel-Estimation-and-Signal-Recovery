function [q_hat,b_hat,x_hat,iter_flag]=ML_UTBiGAMP(Rec_Y,Y_noise,Hr,Hb,X,var_channel,Hr_loc,Hb_loc,S_loc,HbX_loc,K_p,T_p,N_p,iter,damping,damping_r,Rec_Y_pilot)
...
%         
        for tt=1:4
           ...
           [Z_nt,V_nt,V_bar_nt,b_hat,x_hat,v_b,v_x]=Forw_iter(1,prior_X_mean,prior_X_var,prior_H,Sigma_x,R_x,Sigma_b,R_b,s_tilde_nt,X,T_p,q_hat_new.',K,V_nt_former,b_hat_former,N_p,Hb,Z_nt_pilot,V_nt_pilot,0.7,tt,S_loc,Hb_loc,HbX_loc,Hr_loc);
           V_nt_former=V_nt;
           b_hat_former=b_hat;
