function [q_hat,b_hat,x_hat]=ML_BiGAMP_EP(Rec_Y,Y_noise,Hr,Hb,X,var_channel,Hr_loc,Hb_loc,S_loc,HbX_loc,K_p,T_p,N_p,iter,damping,damping_r,Rec_Y_pilot)
...
%         [q_hat_new,v_q_new,~]=Single_GAMP(prior_X_mean_new,prior_X_var_new,prior_H_mean_new,prior_H_var_new,A_eq,T,damping_r,Rec_Y.',Y_noise.',Hr_loc.',var_channel,iter,Hr.',K_p);
%         q_hat=q_hat_new.';
%         v_q=v_q_new.';
